...
using EnergyEndpointManager.API.Repositories;
using EnergyEndpointManager.API.Services;
...
builder.Services.AddDbContext<EnergyEndpointManagerDbContext>(opt => opt.UseInMemoryDatabase("EnergyEndpointManagerDB"));
